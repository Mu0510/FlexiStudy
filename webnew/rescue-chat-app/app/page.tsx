...
const buildLockMessage = (isNotifyBusy: boolean, notifyBusyReason: string | null, isModelRestarting: boolean) => {
...
export default function RescueChatPage() {
  ...
  const lockMessage = buildLockMessage(isNotifyBusy, notifyBusyReason, isModelRestarting)

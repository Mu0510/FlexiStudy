...
export function NewChatPanel({
  ...
  }, [online, toast, selectedFiles, selectedGoal, selectedSession, clearMessages, sendMessage, setInput, setSelectedFiles, onClearSelectedGoal, onClearSelectedSession, webSearchFlag]);

            ...
            <div key={msg.id}>
              {msg.type === "tool" ? (
                ...
                <div className={cn("flex space-x-3", msg.role === "user" ? "justify-end" : "justify-start")}>
                  ...
                  <div
                    className={`prose rounded-2xl ${msg.role === "user" ? "bg-primary-800 text-neutral-100 max-w-[70%] px-4 py-3 my-2" : "w-[90%] bg-transparent text-neutral-900 my-1 mb-5"} ${msg.role === "assistant" && "animate-pulse"}`}

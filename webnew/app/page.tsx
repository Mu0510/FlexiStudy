...
export default function StudyApp() {
  ...
  const { messages, activeMessage, isGeneratingResponse, isNotifyBusy, notifyBusyReason, isModelRestarting, sendMessage, cancelSendMessage, requestHistory, isFetchingHistory, historyFinished, clearMessages, sendToolApproval } = useChat({
    onMessageReceived: () => {
      ...
      case "system-chat":
        return <NewChatPanel 
            ...
            setInput={setChatInput}
                  ...
                  lockMessage={isModelRestarting ? 'Geminiを再起動中です…' : notifyLockMessage}
